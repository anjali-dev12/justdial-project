  ...
  return (
    <div className="min-h-screen bg-white flex flex-col mx-50 border border-gray-200">
      ...
      <header className="flex items-center justify-between px-4 py-3 border-b border-gray-300">
        ...
        <span className="text-[16px] font-medium">Reservation</span>
      ...
      <div className="sticky bottom-0 bg-white border-t border-gray-200 p-4 flex justify-center">
        <button className="w-100 bg-blue-600 text-white py-3 rounded-md">
          Save
        </button>
      </div>

      {/* Booking Bottom Modal */}
      {showBookingModal && (
        <div className="fixed inset-0 bg-black/30 flex items-end justify-center z-50">

          <div className="bg-white w-full max-w-4xl min-h-[250px] rounded-t-2xl p-5 animate-[slideUp_.3s_ease-out]">
